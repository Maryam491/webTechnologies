...
const sampleProducts = [
  ...
  // SALE
  { name: 'Discounted Lawn Collection', price: 1999, category: 'SALE', rating: 4.3, stock: 80, description: '50% off on select lawn pieces.', image: '/images/l2.jpg' },
  { name: 'Sale Unstitched Fabric', price: 799, category: 'SALE', rating: 4.2, stock: 100, description: 'Affordable unstitched fabric on sale.', image: '/images/kid2.png' },
  { name: 'Clearance Ready-to-Wear', price: 2499, category: 'SALE', rating: 4.1, stock: 55, description: 'End of season clearance sale.', image: '/images/men2.jpg' },
  { name: 'Flash Sale Kurtis', price: 899, category: 'SALE', rating: 4.4, stock: 70, description: 'Limited time flash sale on kurtis.', image: '/images/dress4.jpg' },
